...
EXECUTOR_URL="https://github.com/t3rn/executor-release/releases/download/v0.37.0/executor-linux-v0.37.0.tar.gz"
EXECUTOR_FILE="executor-linux-v0.37.0.tar.gz"
